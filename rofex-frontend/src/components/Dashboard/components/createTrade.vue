              ...
              <div class="col-md-12">
                <div class="loginWr">
                    <form v-on:submit.prevent ="createTrad" class="formWra">
                        <h1 class="text-center titletrade"><strong> Ingrese su Trade</strong><hr class="linea"> </h1>                    
                        <div class="UIWr">                            
                            <label for="firstname">
                                <p>Symbol</p>                             
                                <select name="Symbol" id="Symbol" class="inputData" v-model="Symbol" >
                        ...
                        <div class="UIWr">
                            <label for="Size">
                                <p>Size  </p>
                                <input type="number" v-on:click="clearError" v-model="Size" id="Size" class="inputData" value="" />
                        ...
                        <div class="UIWr">
                            <label for="Price">
                                <p>Price</p>
                                <input type="number" v-on:click="clearError" v-model="Price" id="Price" class="inputData" value="" />
                        ...
                        <div class="UIWr">
                            <label for="Datetime">
                                <p>Datetime</p>
                                <input type="datetime-local" v-on:click="clearError" id="Datetime" v-model="Datetime" class="inputData" value="" />
                        ...
                        <div v-if="errorMessage" class="errormessage">
                            ...
                            <div><button type="submit" class="submitbtnTrade">Crear</button></div>
                    </form>
                </div>
            </div>
          </div>
